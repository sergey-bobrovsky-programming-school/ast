...
public class BSTTest {
  ...
  @Nested
  @DisplayName("DeepAllNodes")
  class DeepAllNodes {
    @Test
    @DisplayName("Return nodes in in-order")
    void returnNodesInInOrder() {
      BSTNode<Integer> root = new BSTNode<Integer>(100, 100, null);
      BST<Integer> tree = new BST<Integer>(root);
      ...
      ArrayList<BSTNode> result = tree.DeepAllNodes(0);

      Assertions.assertEquals(7, result.size());
      Assertions.assertEquals(70, result.get(0).NodeKey);
      Assertions.assertEquals(80, result.get(1).NodeKey);
      Assertions.assertEquals(90, result.get(2).NodeKey);
      Assertions.assertEquals(100, result.get(3).NodeKey);
      Assertions.assertEquals(110, result.get(4).NodeKey);
    ...
    @Test
    @DisplayName("Return nodes in pre-order")
    void returnNodesInPreOrder() {
      BSTNode<Integer> root = new BSTNode<Integer>(100, 100, null);
      BST<Integer> tree = new BST<Integer>(root);
      ...
      ArrayList<BSTNode> result = tree.DeepAllNodes(2);

      Assertions.assertEquals(7, result.size());
      Assertions.assertEquals(100, result.get(0).NodeKey);
      Assertions.assertEquals(80, result.get(1).NodeKey);
      Assertions.assertEquals(70, result.get(2).NodeKey);
      Assertions.assertEquals(90, result.get(3).NodeKey);
      Assertions.assertEquals(120, result.get(4).NodeKey);
      Assertions.assertEquals(110, result.get(5).NodeKey);
      Assertions.assertEquals(130, result.get(6).NodeKey);
    }
  }
}
